...
#<!---prototype user password user for demo
VALID_CREDENTIALS = {'email': 'user@gmail.com', 'password': 'password123'}
...
def send_message():
    ...
    try:
        if file:
            ...
            file.save(file_path)
            print(f"File uploaded: {file.filename}, MIME type: {file.mimetype}") 
